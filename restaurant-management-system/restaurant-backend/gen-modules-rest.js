...
// ========== MENU ==========
w('modules/menu/dto/MenuCategoryRequest.java', `package com.restaurantmanagement.modules.menu.dto;
...
w('modules/menu/dto/MenuCategoryResponse.java', `package com.restaurantmanagement.modules.menu.dto;
import com.restaurantmanagement.modules.menu.entity.CategoryType;
...
w('modules/menu/dto/MenuItemRequest.java', `package com.restaurantmanagement.modules.menu.dto;
...
w('modules/menu/dto/MenuItemResponse.java', `package com.restaurantmanagement.modules.menu.dto;
...
w('modules/menu/dto/MenuModifierRequest.java', `package com.restaurantmanagement.modules.menu.dto;
...
w('modules/menu/dto/MenuModifierResponse.java', `package com.restaurantmanagement.modules.menu.dto;
import com.restaurantmanagement.modules.menu.entity.ModifierType;
import lombok.Builder; import lombok.Data; import java.math.BigDecimal;
...
w('modules/menu/dto/QrMenuResponse.java', `package com.restaurantmanagement.modules.menu.dto;
import lombok.Builder; import lombok.Data;
...
w('modules/menu/mapper/MenuMapper.java', `package com.restaurantmanagement.modules.menu.mapper;
...
w('modules/menu/service/MenuService.java', `package com.restaurantmanagement.modules.menu.service;
import com.restaurantmanagement.modules.menu.dto.*;
import com.restaurantmanagement.modules.menu.entity.*;
...
public class MenuService {
    ...
    public QrMenuResponse getQrMenu(String qrCode) {
        ...
        List<MenuItemResponse> items = categories.stream()
                .flatMap(c -> itemRepository.findByCategoryId(c.getId()).stream().map(MenuMapper::toItem)).toList();
...
w('modules/menu/controller/MenuController.java', `package com.restaurantmanagement.modules.menu.controller;
import com.restaurantmanagement.modules.menu.dto.*;
